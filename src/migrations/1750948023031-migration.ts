...
export class Migration1750948023031 implements MigrationInterface {
  name = "Migration1750948023031";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`employees\` (\`id\` int NOT NULL AUTO_INCREMENT, \`employee_number\` varchar(255) NOT NULL, \`employee_first_name\` varchar(255) NOT NULL, \`employee_last_name\` varchar(255) NOT NULL, \`employee_email\` varchar(255) NULL, \`location_id\` int NOT NULL, \`position_id\` int NOT NULL, \`status_id\` int NOT NULL DEFAULT '1', \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`modified_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`created_by\` int NULL, \`updated_by\` int NULL, UNIQUE INDEX \`IDX_8878710dc844ecd6f9e587f34f\` (\`employee_number\`), UNIQUE INDEX \`IDX_9c2395782886c2c335e94f04a8\` (\`employee_email\`), UNIQUE INDEX \`IDX_4a12bcabf704e1820e9f997704\` (\`employee_number\`, \`employee_first_name\`, \`employee_last_name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`
    );
    await queryRunner.query(
