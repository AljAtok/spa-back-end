...
export class Migration1751287728388 implements MigrationInterface {
    name = 'Migration1751287728388'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`warehouse_employees\` (\`id\` int NOT NULL AUTO_INCREMENT, \`warehouse_id\` int NOT NULL, \`assigned_ss\` int NOT NULL, \`assigned_ah\` int NOT NULL, \`assigned_bch\` int NOT NULL, \`assigned_gbch\` int NULL, \`assigned_rh\` int NOT NULL, \`assigned_grh\` int NULL, \`status_id\` int NOT NULL DEFAULT '1', \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`modified_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`created_by\` int NULL, \`updated_by\` int NULL, UNIQUE INDEX \`IDX_c36311cde57f547fe6585efd25\` (\`warehouse_id\`, \`assigned_ss\`, \`assigned_ah\`, \`assigned_bch\`, \`assigned_gbch\`, \`assigned_rh\`, \`assigned_grh\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
